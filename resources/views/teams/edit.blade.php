                                ...
                                <div class="row mt-3">
                                    <div class="col pe-0">
                                        <div class="form-left h-100 py-5 px-5">
                                            <form action="{{ route('teams.update', $team->id) }}" method="POST" class="row g-4">
                                            @csrf
                                            @method('PUT')
                                            <input type="hidden" name="team_id" value="{{ $team->id }}">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="project_title" id="project_title" class="form-control @error('project_title') is-invalid @enderror" placeholder="Enter Project's Name" value="{{ $team->project_title }}">
                                                        </div>
                                                        @error('project_title')
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="team_name" id="team_name" class="form-control @error('team_name') is-invalid @enderror" placeholder="Enter Team's Name" value="{{ $team->team_name }}">
                                                        </div>
                                                        @error('team_name')
                                                        <i><span class="text-danger ms-1 validation-msg">{{ $message }}</span></i>
                                                        @enderror
                                                    ...
                                                    <tbody>
                                                        @foreach($users as $user)
                                                            <tr>
                                                                <th scope="row">
                                                                    <input class="form-check-input @error('users') is-invalid @enderror" 
                                                                        type="checkbox" 
                                                                        name="users[]" 
                                                                        value="{{ $user->id }}"
                                                                        @if(in_array($user->id, $team->users->pluck('id')->toArray())) checked @endif>
                                                                </th>
                                                                <td>{{ $user->id }}</td>
                                                                <td>{{ $user->name }}</td>
                                                                <td>{{ $user->email }}</td>
                                                ...
                                                @enderror
                                                    ...
                                                    <div class="col-12">
                                                        <button type="submit" class="btn btn-dark px-4 float-end mt-4">Update</button>
                                                    </div>
                                            </form>
                                        </div>
                                    </div>
